...
<img src="https://tdn.danny.is/_astro/icon-1024-trans.JlQ0uZ5x_Zi7Wt3.webp" width="100" alt="Taskdn icon">
<br><strong>taskdn</strong>
</a>
<br><br>
A markdown-based task management system including mac app, CLI, plus Claude Code & Obsidian Plugins.
</td>
<td align="center" width="50%">
<a href="https://github.com/dannysmith/astro-editor">
<img src="https://astroeditor.danny.is/icon.png" width="100" alt="Astro Editor icon">
<br><strong>Astro Editor</strong>
</a>
<br><br>
A specialized schema-aware markdown editor for Astro content collections.
</td>
</tr>
</table>
...
### Recent Releases
<!-- releases starts -->
- [astro-editor v1.0.9](https://github.com/dannysmith/astro-editor/releases/tag/v1.0.9) <small>(Feb 16)</small>
- [astro-editor v1.0.8](https://github.com/dannysmith/astro-editor/releases/tag/v1.0.8) <small>(Feb 14)</small>
- [astro-editor v1.0.7](https://github.com/dannysmith/astro-editor/releases/tag/v1.0.7) <small>(Jan 25)</small>
- [astro-editor v1.0.6](https://github.com/dannysmith/astro-editor/releases/tag/v1.0.6) <small>(Jan 21)</small>
- [obsidian-taskdn 0.2.4](https://github.com/dannysmith/obsidian-taskdn/releases/tag/0.2.4) <small>(Jan 19)</small>
<!-- releases ends -->
...
- [A Social Filesystem by Dan Abramov](https://danny.is/notes/2026-01-21-a-social-filesystem-by-dan/) <small>(Jan 21)</small>
- [Quoting Jim Nielsen: To Make Software Is To Translate Human Intent Into Computational Precision](https://danny.is/notes/2026-01-09-quoting-jim-nielsen-to-make/) <small>(Jan 09)</small>
- [Quoting Tomasz Tunguz - The Text Box Isn't Enough](https://danny.is/notes/2026-01-09-the-text-box-isnt-enough/) <small>(Jan 09)</small>
<!-- notes ends -->
